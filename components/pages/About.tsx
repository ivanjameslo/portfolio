...
export default function About() {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            if (entry.target === resumeRef.current) setVisibleSections((prev) => ({ ...prev, resume: true }));
          }
        });
      },
      {
  ...
  return (
    <div className="mt-15 flex flex-col items-center justify-center px-3 py-10 lg:px-20 lg:py-20 w-full">
        ...
        <div className="animate-fade-right mt-30 grid grid-cols-1 lg:grid-cols-5 gap-8 px-3 lg:px-40">
            {/* Image */}
        ...
        <div
          ref={resumeRef}
          className={`mt-15 w-full px-3 lg:px-40 flex justify-center mb-25 lg:mb-25 ${
            visibleSections.resume ? "animate-fade-right" : "before-fade-right"
          }`}
        >
          <Buttons 
            variant="outline" 
